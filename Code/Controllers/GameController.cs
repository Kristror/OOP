...
public sealed class GameController : MonoBehaviour, IDisposable
{
    ...
    private void Awake()
    {
        ...
        _saveDataRepository = new SaveDataRepository(_interactiveObject);

        if (Application.platform == RuntimePlatform.WindowsEditor)
        {
            _inputController = new InputController(player, _saveDataRepository);
        ...
        _radar = _reference.Radar;
        _interactiveObject.AddExecuteObject(_radar);
        FillInterObjects();
        FillCheckObjects();
